...
const file_internal_infra_grpc_protofiles_order_proto_rawDesc = "" +
	...
	"finalPrice\".\n" +
	"\tOrderList\x12!\n" +
	"\x06orders\x18\x01 \x03(\v2\t.pb.OrderR\x06orders\"n\n" +
	...
	"\n" +
	"ListOrders\x12\t.pb.Blank\x1a\r.pb.OrderListB\x18Z\x16internal/infra/grpc/pbb\x06proto3"
...
var file_internal_infra_grpc_protofiles_order_proto_depIdxs = []int32{
	...
	4, // 3: pb.OrderService.CreateOrder:output_type -> pb.CreateOrderResponse
